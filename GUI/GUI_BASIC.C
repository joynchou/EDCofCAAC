...
****************************************************************************/
void  GUI_Rectangle(u16 x0, u16 y0, u16 x1, u16 y1, TCOLOR color)
...
* 说明：操作失败原因是指定地址超出有效范围。
****************************************************************************/
void  GUI_RectangleFill(u16 x0, u16 y0, u16 x1, u16 y1, TCOLOR color)
{  u16  i;
...
* 说明：操作失败原因是指定地址超出有效范围。
****************************************************************************/
void  GUI_Square(u16 x0, u16 y0, u16  with, TCOLOR  color)
{   if(with==0) return;
...
* 说明：操作失败原因是指定地址超出有效范围。
****************************************************************************/
void  GUI_LineWith(u16 x0, u16 y0, u16 x1, u16 y1, uint8 with, TCOLOR color)
{  int   dx;						// 直线x轴差值变量
   int   dy;          			// 直线y轴差值变量
   int8    dx_sym;					// x轴增长方向，为-1时减值方向，为1时增值方向
   int8    dy_sym;					// y轴增长方向，为-1时减值方向，为1时增值方向
...
* 说明：操作失败原因是指定地址超出有效范围。
****************************************************************************/
void  GUI_LineS(u16 const *points, uint8 no, TCOLOR color)
{  u16  x0, y0;
   u16  x1, y1;
   uint8  i;
...
* 说明：操作失败原因是指定地址超出有效范围。
****************************************************************************/
void  GUI_Circle(u16 x0, u16 y0, u16 r, TCOLOR color)
...
* 说明：操作失败原因是指定地址超出有效范围。
****************************************************************************/
void  GUI_CircleFill(u16 x0, u16 y0, u16 r, TCOLOR color)
{  int  draw_x0, draw_y0;			// 刽图点坐标变量
   int  draw_x1, draw_y1;	
   int  draw_x2, draw_y2;	
   int  draw_x3, draw_y3;	
...
* 说明：操作失败原因是指定地址超出有效范围。
****************************************************************************/
void  GUI_Ellipse(u16 x0, u16 x1, u16 y0, u16 y1, TCOLOR color)
{  int  draw_x0, draw_y0;			// 刽图点坐标变量
   int  draw_x1, draw_y1;
   int  draw_x2, draw_y2;
   int  draw_x3, draw_y3;
...
* 说明：操作失败原因是指定地址超出有效范围。
****************************************************************************/
void  GUI_EllipseFill(u16 x0, u16 x1, u16 y0, u16 y1, TCOLOR color)
{  int  draw_x0, draw_y0;			// 刽图点坐标变量
   int  draw_x1, draw_y1;
   int  draw_x2, draw_y2;
   int  draw_x3, draw_y3;
...
* 说明：若没有找出，则返回最左的x坐标0。
****************************************************************************/
u16  GUI_ReadLeftPoint(u16 x0, u16 y0, TCOLOR color)
{  u16  i;
   TCOLOR  bakc;
...
****************************************************************************/
u16  GUI_ReadRightPoint(u16 x0, u16 y0, TCOLOR color)
{  u16  i;
   TCOLOR  bakc;
...
* 说明：
****************************************************************************/
int  GUI_CmpPointColor(u16 x, u16 y, TCOLOR color)
{  TCOLOR  bakc;
...
****************************************************************************/
void  GUI_FloodFill(u16 x0, u16 y0, TCOLOR color)
...
* 说明：操作失败原因是指定地址超出有效范围。
****************************************************************************/
void  GUI_Arc4(u16 x, u16 y, u16 r, uint8 angle, TCOLOR color)
{  int  draw_x, draw_y;
...
* 说明：操作失败原因是指定地址超出有效范围。
****************************************************************************/
void  GUI_Arc(u16 x, u16 y, u16 r, u16 stangle, u16 endangle, TCOLOR color)
...
* 说明：操作失败原因是指定地址超出有效范围。
****************************************************************************/
void  GUI_Pieslice(u16 x, u16 y, u16 r, u16 stangle, u16 endangle, TCOLOR color)
{  int  draw_x, draw_y;					// 画图坐标变量
   int  op_x, op_y;						// 操作坐标
   int  op_2rr;							// 2*r*r值变量
