...
*历史修改记录
作者  |  日期  |  版本  |  描述
周晨阳| 	5/17   |	1.0	 |	注意：new_no 不能等于old_no
...
/*--  宽度x高度=49x14  --*/
/*--  宽度不是8的倍数，现调整为：宽度x高度=56x14  --*/
code uint8  const  button_cancle[] =
{
0x07,0xFF,0xFF,0xFF,0xFF,0xF0,0x00,0x18,0x00,0x00,0x00,0x00,0x0C,0x00,0x20,0x00,
...
/*--  宽度x高度=49x14  --*/
/*--  宽度不是8的倍数，现调整为：宽度x高度=56x14  --*/
code uint8  const  button_cancle1[] =
{
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x07,0xFF,0xFF,0xFF,0xFF,0xF0,0x00,0x1F,0xFF,
...
* 出口参数：无
****************************************************************************/
void  GUI_Button49x14(u16 x, u16 y, uint8 *dat)
...
* 出口参数：无
****************************************************************************/
void  GUI_Button_OK(u16 x, u16 y)
...
* 出口参数：无
****************************************************************************/
void  GUI_Button_OK1(u16 x, u16 y)
...
* 出口参数：无
****************************************************************************/
void  GUI_Button_Cancle(u16 x, u16 y)
...
* 出口参数：无
****************************************************************************/
void  GUI_Button_Cancle1(u16 x, u16 y)
...
*历史修改记录
作者  |  日期  |  版本  |  描述
周晨阳| 	5/17   |	1.0	 |	注意：ico 的x坐标不能小于5，不能大于90 ，
													图标的title必须写，不能为空
