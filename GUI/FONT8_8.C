...
/* 8*8字体定义 */
code const uint8  FONT8x8ASCII[][8] = {
/* 空格 */
  {
   ________,
   ________,
...
****************************************************************************/
uint8  GUI_PutChar8_8(u16 x, u16 y, uint8 ch)
{  uint8   font_dat;
   uint8   i, j;
   TCOLOR  bakc;
...
* 说明：操作失败原因是指定地址超出有效范围。
****************************************************************************/
void  GUI_PutString8_8(u16 x, u16 y, char *str)
{  while(1)
   {  if( (*str)=='\0' ) break;
...
* 说明：操作失败原因是指定地址超出有效范围。
****************************************************************************/
void  GUI_PutNoStr8_8(u16 x, u16 y, char *str, uint8 no)
{  if(no==0) return;
   for(; no>0; no--)
   {  if( (*str)=='\0' ) break;
      if( GUI_PutChar8_8(x, y, *str++)==0 ) break;
