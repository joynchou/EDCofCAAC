...
static unsigned char firstMenuNum=1;
static unsigned char SecondMenuNum=1;
static char menu_MAX,menu_MIN ;
...
#endif
            BUTTON1_bit=1;
            if(firstMenuNum>=menu_MAX)
            {
//                firstMenuNum=menu_MAX;
            }
            else
            {
//                firstMenuNum++;
...
#endif
            BUTTON2_bit=1;
            if(firstMenuNum<=menu_MIN)
            {
                firstMenuNum=menu_MIN;
            }
            else
            {
                firstMenuNum--;
